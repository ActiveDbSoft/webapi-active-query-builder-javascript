...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebapiActiveQueryBuilder.TransformResult();
  });
  ...
  describe('TransformResult', function() {
    it('should create an instance of TransformResult', function() {
      // uncomment below and update the code to test TransformResult
      //var instane = new WebapiActiveQueryBuilder.TransformResult();
      //expect(instance).to.be.a(WebapiActiveQueryBuilder.TransformResult);
    });
