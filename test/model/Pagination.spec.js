...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebapiActiveQueryBuilder.Pagination();
  });
  ...
  describe('Pagination', function() {
    it('should create an instance of Pagination', function() {
      ...
      //var instane = new WebapiActiveQueryBuilder.Pagination();
      //expect(instance).to.be.a(WebapiActiveQueryBuilder.Pagination);
    });
