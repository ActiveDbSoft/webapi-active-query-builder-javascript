...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebapiActiveQueryBuilder.SqlQuery();
  });
  ...
  describe('SqlQuery', function() {
    it('should create an instance of SqlQuery', function() {
      // uncomment below and update the code to test SqlQuery
      //var instane = new WebapiActiveQueryBuilder.SqlQuery();
      //expect(instance).to.be.a(WebapiActiveQueryBuilder.SqlQuery);
    });
